...
<div class="row">
    <div class="col-md-4 col-md-offset-4">
        ...
        <div class="form-group">
            ...
            {{ Form::radio('status', '1', $product->status == false ? false : true, array('class' => '')) }} {{ trans('message.Approved') }}
            {{ Form::radio('status', '0', $product->status == false ? false : true, array('class' => '')) }} {{ trans('message.Appending') }}
        </div>
